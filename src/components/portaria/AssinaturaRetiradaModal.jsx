...
// Modal de retirada de encomenda: captura a assinatura de quem retirou em um canvas
export default function AssinaturaRetiradaModal({ encomenda, titulo, onConfirmar, onCancelar }) {
  ...
  return (
    <div className="modal-overlay" role="presentation">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Confirmar retirada de encomenda"
      >
        ...
        <div className="modal-body">
          <p className="modal-info">
            Encomenda de <strong>{titulo}</strong> · {encomenda.unidade}
